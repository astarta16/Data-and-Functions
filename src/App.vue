<template>
  ...
  <h3 v-if="courseGoal.visible">{{ courseGoal.text }}</h3>
  <!-- Task 2: Toggle (show/ hide) the goal with help of the button  -->
  <button @click="hideCourseGoal">Toggle Goal</button>
...
function hideCourseGoal() {
  courseGoal.visible = !courseGoal.visible
}
</script>
